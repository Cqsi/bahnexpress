...
export default function Pros() {
  ...
  return (
    ...
    <div className="px-5 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-12">
      <div className="bg-green-200 rounded-lg max-w mx-auto p-8 pt-16">
          ...
          <div className="container mx-auto px-4 py-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {stats.map((stat, index) => (
                <div key={index} className="flex flex-col items-center justify-center p-4 bg-background">
                  <span className={`text-5xl md:text-6xl font-bold mb-2 ${index === 1 ? 'text-green-500' : 'text-primary'}`}>
                    {stat.number}
                  </span>
